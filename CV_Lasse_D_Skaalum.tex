...
\begin{paracol}{2}
	...
	\begin{rightcolumn}
		...
		Jeg har 4 års fuldtidserfaring som softwareudvikler og har altid haft tekniske projekter, som jeg har kastet mig over efter arbejde - alt fra startups til home automation.\\

		Hvis I vælger at ansætte mig, så vil I få en selvdisciplineret, udadvendt og dygtig softwareudvikler, som trives med ansvar og foretrækker at tage ansvar for at drive samarbejde og udvikling i teamet.
		}
