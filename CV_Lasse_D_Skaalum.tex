...
\begin{paracol}{2}
	...
	\begin{rightcolumn}
		...
		{\cvlist{
			\item ASP.NET, React.js, React Native, OpenAPI (Swagger), Entity Framework Core, Azure, Git
		}}%Involverede teknologier
		{\cvlist{
		...
		{\cvlist{
				\item ASP.NET, React.js, React Native, OpenAPI (Swagger), Entity Framework Core, MS SQL, Azure, Docker, Git
			}}%Involverede teknologier
		{}%Resultater
