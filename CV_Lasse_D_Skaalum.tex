...
\begin{paracol}{2}
	...
	\begin{rightcolumn}
		...
		{\cvlist{
			...
			\item Leverede en LLM-baseret platform, der automatiserer forsikringsmægleres kerneprocesser.
			...
			\item Gennemførte en Azure cloudmigrering af Banedanmarks webapplikation, Mobile Kontrolskemaer (MKS).
