...
\begin{paracol}{2}
	...
	\begin{rightcolumn}
		...
		{Softwarekonsulent}
		{Trifork - København}
		{Ledende levering af Corax AI til en forsikringsmægler}
		{\cvlist{
			\item Ansvarlig for den tekniske levering af en \href{https://trifork.com/corax-ai/}{Corax AI}-drevet platform, der automatiserer kerneprocesser hos en forsikringsmægler, i tæt samarbejde med kundens ledelse.
		}}%Arbejdsopgaver
		{\cvlist{
			\item Azure, Docker, Quarkus (Java), Terraform, GitHub Actions, Next.js (TypeScript)
