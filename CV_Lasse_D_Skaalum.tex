...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		\vspace{1pt}
		\cvsection{KONTAKT}\\
		\icontext{MapMarker}{12}{Poul Hartlings Gade 5, 1.tv, 2300 København S}{black}\\[6pt]
		...
		\cvlist{
			...
			\item \href{https://www.stigpaa.dk/}{Stig På} - sammenligningsplatform til offentlig transport i DK
		}
	...
	\begin{rightcolumn}
		...
		\fcolorbox{white}{darkcol}{\begin{minipage}[c][3.5cm][c]{1\mpwidth}
				...
				\large{ \textcolor{white} {Senior Softwareudvikler} }
				\end {center}
			\end{minipage}} \\[14pt]
		\vspace{-12pt}
		...
		\cvtext{Jeg er en ambitiøs, ekstrovert og driftig full-stack softwareudvikler med flair for komplekse backendopgaver, som graviterer mod arbejdspladser, hvor socialt samvær og vidensdeling er i fokus.\\
		
		Jeg har 4 års fuldtidserfaring som softwareudvikler og har altid haft tekniske projekter, som jeg har kastet mig over efter arbejde - alt fra startups til home automation. Jeg har desuden solid erfaring med rekruttering, salg og ledelse.\\

		Hvis I vælger at ansætte mig, så vil I få en selvdisciplineret, udadvendt og dygtig softwareudvikler, som naturligt tager ansvar for at drive samarbejde og udvikling i teamet.
		}
		...
		{Softwarekonsulent}
		{Trifork}
		{Konsulent på tværs af flere projekter og kunder. Har udover softwareudvikling også haft ansvar for salg, rekruttering og ledelse.}
		{\cvlist{
			\item \textbf{Udstationeret i 14 måneder i Muscat, Oman}. Resten af min tid har jeg udviklet projekter for kunder i Københavnsområdet.
			\item Ansvarlig for softwareudvikling samt udskiftning af fysisk hardware på en Big Data platform med yderst store datamængder.
			\item Pitchede \href{https://trifork.com/corax-ai/}{Corax AI} og \href{https://trifork.com/dataplatform/}{Corax Data} for potentielle kunder.
			\item Ansatte flere softwareudviklere, herunder en senior softwareudvikler, og har haft ansvar for onboarding og oplæring af disse.
		}}%Arbejdsopgaver
		{\cvlist{
		...
		{\cvlist{
			\item Ledede et team på 2 udviklere og 1 praktikant i udviklingen af en LLM-baseret platform, der automatiserer forsikringsmægleres kerneprocesser. Platformen reducerer mæglernes tidsforbrug med over 75\%.
			\item Drev LLM-adoption og change management hos en stor dansk offentlig kunde sideløbende med levering af en on-prem PoC.
			\item Leverede en LLM-baseret mødereferatsløsning til flere danske fonde.
			\item Udviklede middleware mellem SAP og MongoDB's Realm med microservices ifbm. udvikling af Banedanmarks app, VHQM.
			\item Ledede en Azure cloudmigrering af Banedanmarks webapplikation, Mobile Kontrolskemaer (MKS).
		...
		{Interim CTO}
		{DJTILBUD (deltid)}
		{Stod for at udvikle \href{https://djtilbud.dk/}{DJTILBUD}s platform fra bunden af, hvor kunder kan modtage tre tilbud fra forskellige DJs.}
		{}%Arbejdsopgaver
		{\cvlist{
			\item React.js (TypeScript), Next.js, Supabase, Grafana
			}}%Involverede teknologier
		{\cvlist{
			\item Skalerede virksomheden til 300.000 kr./md. i omsætning.
			\item Jobsamtaler samt oplæring af udenlandske software freelancere og potentielle CTOs.
		}}%Resultater
		...
		{Instructr}
		{Instructr var en B2B SaaS-virksomhed, hvor vi byggede et white-label hybrid learning produkt til sportsskoler som f.eks. ski- og surfskoler.}
		{\cvlist{
		...
		{\cvlist{
			\item Fuldt funktionel MVP lancering med separerede dev og prod miljøer.
		...
		{}
		{\cvlist{
				\item Udvikling af HR-datasystem for en stor dansk offentlig kunde.
