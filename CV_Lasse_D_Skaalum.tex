...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		\cvlist{
			...
			\item Kinesisk, Arabisk, Tysk, Svensk, Norsk (Grundlæggende)
		}
	...
	\begin{rightcolumn}
		...
		\cvtext{Jeg er en ambitiøs, ekstrovert og entreprenant full-stack softwareudvikler med flair for komplekse backendopgaver, som graviterer mod arbejdspladser, hvor socialt samvær og vidensdeling er i fokus.\\
		...
		{\cvlist{
			\item Udstationeret i 14 måneder i Muscat, Oman.
