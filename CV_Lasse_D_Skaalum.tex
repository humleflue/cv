...
\begin{paracol}{2}
	...
	\begin{rightcolumn}
		...
		{\cvlist{
			\item Drev LLM-adoption og change management hos en stor dansk offentlig kunde.
			\item Ledede udviklingen af en LLM-baseret platform, der automatiserer forsikringsmægleres kerneprocesser.
