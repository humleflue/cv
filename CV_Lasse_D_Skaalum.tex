...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		\cvlist{
			...
			\item Generel tech-nørderi (home automation, startups, mm.)
		}
	...
	\begin{rightcolumn}
		...
		\cvevent
		{Jun 23 - nu}
		{Softwarekonsulent (LLM/AI)}
		{Trifork (København)}
		{}
		{\cvlist{
			\item Lykkedes med et større change management og LLM adoption projekt for en stor dansk offentlig kunde gennem udvikling af LLM-baserede softwareløsninger.
			\item Ansvarlig for leverencen af en LLM-baseret \href{https://trifork.com/corax-ai/}{Corax AI}-drevet platform, der automatiserer en forsikringsmæglers kerneprocesser.
			\item Ansvarlig for en LLM-baseret \href{https://trifork.com/corax-ai/}{Corax AI}-drevet mødereferatsløsning til flere danske fonde.
		}}%Arbejdsopgaver
		{\cvlist{
			\item Azure, Docker, Quarkus (Java), Terraform, GitHub Actions, Next.js (TypeScript), n8n, Python
		}}%Involverede teknologier
		{}%Resultater

		\cvevent
		{Aug 24 - Sep 25}
		{Softwarekonsulent (Big Data)}
		{Trifork (Muscat)}
		{Udstationeret på Big Data projekt}
		{\cvlist{
			\item Ansvarlig for softwareudvikling samt udskifting af fysisk hardware på en Big Data platform med yderst store datamængder.
		...
		{\cvlist{
			\item Spring Boot (Java), Python, Docker, Grafana, Apache Kafka, Apache Flink, Elasticsearch, JavaScript, Ansible
		}}%Involverede teknologier
		{}%Resultater

		\cvevent
		{Jun 23 - Jul 24}
		{Softwarekonsulent (Cloud/Web)}
		{Trifork (København)}
		{}
		{}%Arbejdsopgaver
		{\cvlist{
			\item ASP.NET (C\#), Azure, Docker, React.js (TypeScript), Swift
		}}%Involverede teknologier
		{\cvlist{
