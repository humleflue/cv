...
{Ski Instructor}
{BSI 1}
{Recieved a week of ski instructor education by \textbf{The Danish Ski School} where I passed all of my exams.\\
...
{Recieved a week of parkour instructor education and passed my exam.}
...
\cvevent
	...
	{}%Involverede teknologier
	{\cvlist{
	    \item My mentee has ambitions to become the best in our field, so I have of cause done my very best to make him succeed in this regard. This has resulted in multiple top marks, which he has been very proud of.
...
\cvevent
	...
	{Teaching Assistant}
	{Aalborg University}
	{Teaching Assistent in "Imperative Programming" and "Algorithms and Data Structures".}
	{\cvlist{
...
\cvevent
	...
	{
        % \cvlist {
	    % \item Was the driving force behind streaming our LAN-event, which involved planning the event, setting up the streaming software and finally streaming messages and gameplay during the weekend of the event.
...
\cvevent
	...
	\\\\\textit{My boss' assesment of my work can be sent on request (in danish).}}
	{}%Arbejdsopgaver
	{}%Involverede teknologier
	{}%Resultater
