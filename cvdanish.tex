...
\begin{paracol}{2}
	...
	\begin{rightcolumn}
		...
		\fcolorbox{white}{darkcol}{\begin{minipage}[c][3.5cm][c]{1\mpwidth}
				...
				\large{ \textcolor{white} {Jeg forvandler kaffe til kode} }
				\end {center}
			\end{minipage}} \\[14pt]
		\vspace{-12pt}
		...
		{Instructr | \url{https://www.instructr.io/}}
		{Som teknisk direktør og co-founder af Instructr er jeg ansvarlig for udviklingen af Instructrs digitale platform.}
		{\cvlist{
		...
		{\cvlist{
			\item C\#, React.js, React Native, TypeScript, ASP.NET Web API, OpenAPI (Swagger), Entity Framework Core, Azure SQL, Azure Media Services, Azure Blob Storage, Azure DevOps, Git
		...
		{\cvlist{
				\item C\#, React.js, React Native, ASP.NET Core, ASP.NET Web API, OpenAPI (Swagger), Entity Framework Core, Microsoft SQL Server, Azure Cosmos DB, TypeScript, Swift, Kotlin, Azure DevOps, Docker, Git
			}}%Involverede teknologier
		{\cvlist{
		...
		{}%Involverede teknologier
		{\cvlist{
				\item Min mentee havde ambitioner om at blive den dygtigste software ingeniør, så det gjorde jeg selvfølgelig mit bedste for at hjælpe ham med. Det har resulteret i flere topkarakterer, som han har været meget stolt af.
			}}%Resultater
