...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		{B. Sc. Software}
		{Aalborg University}
		{Studerede til softwareingeniør.\\
	...
	\begin{rightcolumn}
		...
		\cvtext{Jeg er en struktureret, omhyggelig og ambitiøs softwarenørd og leder. Jeg kan byde ind med et stort drive, en lærende tilgang samt en stor nysgerrighed.\\
