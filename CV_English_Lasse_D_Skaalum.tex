...
%				\large{ \textcolor{white} {Turning coffee into code} }
		...
		{Software Consultant}
		{Trifork}
		{Consultant across multiple projects and clients. Beyond software engineering, I have also had responsibilities in sales, recruitment, and leadership.}
		{\cvlist{
		...
		{CTO \& Co-Founder}
		{Instructr}
		{Instructr was a B2B SaaS company where we built a white-label blended learning product for sports schools such as ski and surf schools.}
		{\cvlist{
