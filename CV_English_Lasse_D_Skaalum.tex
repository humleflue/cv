% !TEX root = ./CV_English_Lasse_D_Skaalum.tex
...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		% \cvskill{GitHub Actions}
		%} {1} \\[-2pt]

		\cvskill{Docker}
		{} {1} \\[-2pt]

		\cvskill{OpenCode / Claude Code / Codex CLI}
		{} {1} \\[-2pt]
		...
		\cvskill{Spring Boot / Quarkus (Java)}
		{} {0.9} \\[-2pt]
		...
		\vspace{1pt}
		\cvsection{CONTACT}\\
		\icontext{MapMarker}{12}{Poul Hartlings Gade 5, 1.tv, 2300 Copenhagen S}{black}\\[6pt]
		...
		{A CKAD can design, build, configure, and expose cloud-native applications for Kubernetes.}
		...
		\cvlist{
			...
			\item \href{https://www.stigpaa.dk/}{Stig På} - comparison platform for public transport in DK
		}
...
%				\large{ \textcolor{white} {Turning coffee into code} }
				\large{ \textcolor{white} {Senior Software Engineer} }
				\end {center}
			\end{minipage}} \\[14pt]
		\vspace{-12pt}
		...
		\cvtext{I am an ambitious, extroverted, and entrepreneurial full-stack software engineer with a flair for complex backend work, drawn to workplaces where social connection and knowledge sharing are in focus.\\
		
		I have 4 years of full-time experience as a software engineer and have always pursued technical projects after work - from startups to home automation. I also have solid experience with recruitment, sales, and leadership.\\

		If you choose to employ me, you will get a self-disciplined, outgoing, and skilled software engineer who thrives on responsibility and prefers to take ownership of driving collaboration and development within the team.
		}
		...
		{Software Consultant}
		{Trifork}
		{Consultant across multiple projects. Beyond software engineering, I have also had responsibilities in sales, recruitment, and leadership.}
		{\cvlist{
			\item \textbf{Stationed abroad in Muscat, Oman for 14 months}. The rest of my time I have developed projects for clients in the Copenhagen area.
			\item Responsible for software development and physical hardware replacement on a Big Data platform handling extremely large data volumes.
			\item Pitched \href{https://trifork.com/corax-ai/}{Corax AI} and \href{https://trifork.com/dataplatform/}{Corax Data} to prospective clients.
			\item Hired multiple software developers, including a senior software developer, and was responsible for onboarding and training them.
		}}%Arbejdsopgaver
		{\cvlist{
			\item Azure, Docker, Quarkus (Java), Spring Boot (Java), ASP.NET (C\#), Terraform, GitHub Actions, Next.js (TypeScript), React.js (TypeScript), n8n, Python, Grafana, Apache Kafka, Apache Flink, Elasticsearch, JavaScript, Ansible, Swift
		}}%Involverede teknologier
		{\cvlist{
			\item Led a team of 2 developers and 1 intern in developing an LLM-powered platform that automates core processes for insurance brokers. The platform reduces brokers' time spent by over 75\%.
			\item Drove LLM adoption and change management at a large Danish public sector client alongside delivery of an on-prem PoC.
			\item Delivered an LLM-powered meeting minutes solution to several Danish foundations.
			\item Developed middleware between SAP and MongoDB's Realm using microservices for version 3 of Banedanmark's app, VHQM.
			\item Executed a full Azure cloud migration of Banedanmark's web application, Mobile Kontrolskemaer (MKS).
			\item Developed Speak-S for DSB - a platform used to schedule announcements at S-train stations across Denmark.
		}}%Resultater
		...
		{Interim CTO}
		{DJTILBUD (part-time)}
		{Built \href{https://djtilbud.dk/}{DJTILBUD}'s platform from the ground up, where customers can receive three offers from different DJs.}
		{}%Arbejdsopgaver
		{\cvlist{
			\item React.js (TypeScript), Next.js, Supabase, Grafana
			}}%Involverede teknologier
		{\cvlist{
			\item Scaled the company to 300,000 DKK/month in revenue.
			\item Conducted job interviews and onboarded international software freelancers and potential CTOs.
		}}%Resultater
		...
		{CTO \& Co-Founder}
		{Instructr}
		{Instructr was a B2B SaaS company building a white-label blended learning product for sports schools such as ski and surf schools.}
		{\cvlist{
			\item Full-stack development of the platform (frontend, backend, DevOps, and cloud)
			\item Project management and leading 1 full-time employee and 5 full-time interns
		}}%Arbejdsopgaver
		{\cvlist{
			\item ASP.NET (C\#), React.js (TypeScript), React Native, Azure, GitHub Actions
		}}%Involverede teknologier
		{\cvlist{
			\item Fully functional MVP launch with separated dev and prod environments.
		...
		{}
		{\cvlist{
				\item Developed an HR-forecasting platform for a large Danish public sector client.
				\item Developed a welding emulator in Swift.
			}}%Arbejdsopgaver
		{\cvlist{
