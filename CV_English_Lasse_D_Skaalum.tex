...
%				\large{ \textcolor{white} {Turning coffee into code} }
		...
		I have 4 years of full-time experience as a software engineer and have always pursued technical projects after work - from startups to home automation.\\
		...
		{Software Consultant}
		{Trifork - Copenhagen}
		{Leading Corax AI delivery for an insurance broker}
		{\cvlist{
			\item Owning the technical delivery of a \href{https://trifork.com/corax-ai/}{Corax AI}-powered platform automating core insurance broker processes, partnering with customer leadership.
		}}%Arbejdsopgaver
		{\cvlist{
			\item Azure, Docker, Quarkus (Java), Terraform, Next.js (TypeScript)
		...
		{Software Consultant}
		{Trifork - Muscat}
		{Stationed on a Big Data project}
		{\cvlist{
			\item Led feature delivery, automation on a Big Data platform while mentoring junior engineers to keep ingestion uptime and data integrity intact.
			\item Had a critical role in the project's development, test, and implementation phases.
			\item Pitched \href{https://trifork.com/corax-ai/}{Corax AI} and \href{https://trifork.com/dataplatform/}{Corax Data} to prospective customers in Oman.
		}}%Arbejdsopgaver
		{\cvlist{
		...
		{}
		{\cvlist{
			\item Planned and executed Banedanmark's Mobile Kontrolskemaer (MKS) cloud infrastructure migration
			\item Tied SAP data together with MongoDB's Realm via Node.js microservices for the Vedligehold (VHQM).
			\item Facilitated DSB stakeholder workshops and team alignment on Speak-S despite being the most junior engineer on paper.
		}}%Arbejdsopgaver
		{\cvlist{
			\item ASP.NET (C\#), Azure, Docker, React.js (TypeScript), Node.js
			}}%Involverede teknologier
		{}%Resultater
