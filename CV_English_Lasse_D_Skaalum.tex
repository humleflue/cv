...
\begin{paracol}{2}
	\begin{leftcolumn}
		...
		\vspace{1pt}
		\cvsection{KONTAKT}\\
		\icontext{MapMarker}{12}{Poul Hartlings Gade 5, 1. tv\\2300 Copenhagen, Denmark}{black}\\[6pt]
...
A CKAD can define application resources and use Kubernetes core primitives to create/migrate, configure, expose and observe scalable applications.}
		...
		\cvlist{
			\item Danish (Native)
			\item English (Fluent)
			\item Chinese, Arabic, German, Swedish, Norwegian (Basic)
		}
...
%				\large{ \textcolor{white} {Turning coffee into code} }
		...
		I have 4 years of full-time experience as a software engineer and have always pursued technical projects after work - from startups to home automation. I also have solid experience with recruitment and sales.\\
		...
		{Software Consultant}
		{Trifork}
		{Consultant across multiple projects and clients. Beyond software engineering, I have also had responsibilities in sales and recruitment.}
		{\cvlist{
			\item Stationed abroad in Muscat, Oman for 14 months.
		...
		{\cvlist{
			\item Drove LLM adoption and change management at a large Danish public sector client.
			\item Delivered an LLM-powered platform that automates core processes for insurance brokers.
