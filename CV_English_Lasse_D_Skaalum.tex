...
%		\iconemail{Envelope}{12}{lasse@bluebirdday.dk}{black}\\[6pt]
		\iconemail{Envelope}{12}{ldsk@trifork.com}{black}\\[6pt]
...
%				\large{ \textcolor{white} {Turning coffee into code} }
		...
		I am looking for a new adventure, which allows me to travel outside of little Denmark. I am interested in a lot of different aspects of software development, and I would not mind taking on a role as a mentor. \\
		...
		{}%Arbejdsopgaver
		{\cvlist{
			\item ASP.NET (C\#), Azure, Docker, Git, Kubernetes, React.js (TypeScript), Next.js
			}}%Involverede teknologier
		{\cvlist{
			\item Lead the cloud migration of Banedanmark's enterprise solution, Mobile Kontrolskemaer (MKS).
			\item Lead the development of a broker platform where customers can get three non-binding offers from DJs.
		}}%Resultater
		...
		{\cvlist{
			...
			\item Project management and managing 4 employees
		}}%Arbejdsopgaver
		{\cvlist{
		...
		{\cvlist{
				\item ASP.NET, React.js (TypeScript), React Native, MS SQL, Azure, Docker, Git, Swift, Kotlin
			}}%Involverede teknologier
		{}%Resultater
